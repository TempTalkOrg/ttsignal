...
#ifndef BC_BASE_ATOMICOPS_INTERNALS_ATOMICWORD_COMPAT_H_
#define BC_BASE_ATOMICOPS_INTERNALS_ATOMICWORD_COMPAT_H_
...
#endif  // BC_BASE_ATOMICOPS_INTERNALS_ATOMICWORD_COMPAT_H_
