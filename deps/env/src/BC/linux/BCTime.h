...
#ifndef BC_LINUX_TIME_H_INCLUDED__
#define BC_LINUX_TIME_H_INCLUDED__
...
static inline void FileTimeToBCTime(bc_time_t *result, FILETIME *input)
{
...
BC_API void gettimeofday(struct timeval* t,void* timezone);
...
#endif // BC_LINUX_TIME_H_INCLUDED__
